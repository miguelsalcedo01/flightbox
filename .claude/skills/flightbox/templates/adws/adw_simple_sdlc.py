...
Usage:
    uv run adws/adw_simple_sdlc.py "<prompt or path/to/prompt.md>" [--config adws/adw_flightbox_config/flightbox.config.yaml] [--adw-id a1b2c3d4]
...
def main(prompt: str, config: str = "adws/adw_flightbox_config/flightbox.config.yaml", adw_id: str | None = None) -> int:
    ...
    def commit(ph, envelope) -> None:
        ...
        message = envelope.commit_message or f"flightbox({run.adw_id}): {envelope.summary}"
