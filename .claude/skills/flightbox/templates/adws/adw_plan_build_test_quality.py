...
Usage:
    uv run adws/adw_plan_build_test_quality.py "<prompt or path/to/prompt.md>" [--config adws/adw_flightbox_config/flightbox.config.yaml] [--adw-id a1b2c3d4]
...
def main(prompt: str, config: str = "adws/adw_flightbox_config/flightbox.config.yaml", adw_id: str | None = None) -> int:
    ...
    if verified:
        with run.phase(PhaseParams(name="commit", kind="code", owner="git",
            ...
            message = previous.commit_message or f"flightbox({run.adw_id}): {previous.summary}"
