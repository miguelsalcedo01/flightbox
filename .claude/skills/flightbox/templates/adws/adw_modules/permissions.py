...
Two keys drive it, both in flightbox.config.yaml:
...
from .data_types import AgentConfig, FLIGHTBOXConfig
...
def always_writable(cfg: FLIGHTBOXConfig) -> list[str]:
...
def permitted(path: str, agent: AgentConfig, cfg: FLIGHTBOXConfig) -> bool:
