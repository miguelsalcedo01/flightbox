...
Usage:
    uv run adws/adw_prompt.py "<prompt or path/to/prompt.md>" [--agent builder] [--config adws/adw_flightbox_config/flightbox.config.yaml] [--adw-id a1b2c3d4]
...
def main(prompt: str, agent: str = "builder",
         config: str = "adws/adw_flightbox_config/flightbox.config.yaml", adw_id: str | None = None) -> int:
